...
dog_breeds = [
    'German Shepard', 'Labrador Retriever', 'Greyhound', 'Cocker Spaniel', 'Border Collie', 'Rottweiler', 'St.Bernard',
    'Siberian Husky', 'Jack Russell Terrier', 'Dobermann', 'Bullterrier', 'American Staffordshire Terrier',
    'French Bulldog', 'Kangal Shepherd', 'Arabian Greyhound', 'Irish Wolfhound', 'Bulldog', 'Jack Russell Terrier',
    'Dalmatian', 'Cane Corso', 'Shiba Inu'
]
...
def display_word(breed, guesses):
    ...
    return ' '.join([letter if letter.lower() in guesses or letter == ' ' else '_' for letter in breed])
...
def play_game():
    ...
    while incorrect_guesses < max_incorrect:
        ...
        print(f"{RED}☹︎ SORRY, YOU RAN OUT OF GUESSES!{RESET}\nThe breed was: {YELLOW}{word}{RESET}")


def ask_to_play_again():
    """Asks the user if they want to play again."""
    play_again = input(f"\n{GREEN}Press Enter ⮐ to play again or type 'n' to quit: {RESET}").lower()
    return play_again != 'n'
